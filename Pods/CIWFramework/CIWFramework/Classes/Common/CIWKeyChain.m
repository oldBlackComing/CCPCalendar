...
@implementation CIWKeyChain




#define AppUniqueIdentifier @"AppUniqueIdentifierHunBoHui"
...
+ (NSString *)getAppOnlyIdentifierOnDevice
{
    ...
    NSString *bundleIdentifier = [NSString stringWithFormat:@"%@_CIW",[[NSBundle mainBundle] bundleIdentifier]];

    
    NSMutableDictionary *onlySignDic = [CIWKeyChain load:bundleIdentifier];
    
    NSString *onlySign = [onlySignDic objectForKey:AppUniqueIdentifier];
    
    if ( !onlySign || ![onlySign length]) {
        
        [CIWKeyChain delete:bundleIdentifier];
        ...
        [CIWKeyChain save:bundleIdentifier data:appUniqueIdentifierKVPairs];
